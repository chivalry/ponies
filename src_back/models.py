...
class Pony(db.Model):
    ...
    pony_friendships = db.relationship(
        'PonyFriendship', backref='pony', lazy=True
    )
...
class Hobby(db.Model):
    ...
    friendship_hobbies = db.relationship(
        'FriendshipHobby', backref='hobby', lazy=True
    )
...
class Friendship(db.Model):
    ...
    pony_friendships = db.relationship(
        'PonyFriendship', backref='friendship', lazy=True
    )
...
class FriendshipHobby(db.Model):
    ...
    friendship_id = db.Column(
        db.Integer, db.ForeignKey('friendships.id'), nullable=False
    )
    hobby_id = db.Column(
